...
# Username and Password:
  ...
  - Some example of users' username and password: 
      ...
      - username: giam, password: 12345678 (this account is also an admin. If you login with this account, the "Admin" menu will show up in your navigation bar. And you can view all users' profile and thier post, as well as delete them)
